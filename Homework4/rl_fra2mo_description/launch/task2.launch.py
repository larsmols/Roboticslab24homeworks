...
def generate_launch_description():
    ...
    # Launch rviz2 with the configuration file provided in the package
    rviz_config_file = PathJoinSubstitution([fra2mo_dir, 'rviz_conf', 'explore.rviz'])
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
        output='screen',
        arguments=['-d', "/home/user/ros2_ws/src/Roboticslab24/Homework4/rl_fra2mo_description/rviz_conf/explore.rviz"],
    )
    ...
    return LaunchDescription(
        [
            ...
            slam_launch,
            nav2_bringup_launch,
            #explore_lite_launch, # Uncomment this line to use the explore for autonomous navigation
            rviz_node,
            gazebo_launch,
        ]
    ) 
